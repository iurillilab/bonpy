...
@pytest.mark.parametrize("slicer, expected_shape",
                    [(1, (240, 320)),
                     ([1], (1, 240, 320)),
                     ([1,2,3], (3, 240, 320)),
...
if __name__ == "__main__":
    asset_moviedata_file = Path(__file__).parent / "assets" / "dataset" / "M1" / "20231201" / "095001" / "eye-cam_video_2023-12-14T16_27_20.avi"
